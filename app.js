/* ==========================================================================
   버디로그 (BirdieLog) v10.0 - 핵심 비즈니스 로직 및 벤 호건 레슨 엔진 스크립트
   ========================================================================== */
...
Generated by BirdieLog v10.0 🏌️‍♂️`;
    ...
    function downloadScoreCardImage() {
        ...
        ctx.fillText('Generated by BirdieLog v10.0 Premium', 320, 940);
    ...
    const GOLF_COURSE_DATABASE = {
        ...
        "남여주": {
            "마루": [4, 4, 3, 5, 4, 4, 3, 4, 5],
            "가람": [4, 3, 4, 4, 5, 3, 4, 5, 4],
            "누리": [4, 4, 3, 5, 4, 3, 4, 4, 5]
        },
        "코브스윙": {
            "코브": [4, 4, 3, 5, 4, 4, 3, 4, 5],
            "스윙": [4, 3, 4, 4, 5, 3, 4, 5, 4]
        }
    };
